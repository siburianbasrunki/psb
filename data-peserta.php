...
<head>
    ...
    <title>Halaman ADMIN PSB ITERA</title>
...
<body>
    ...
    <header>
        <h1><a href="beranda.php">Admin PSB ITERA</h1>
        <ul>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="hapus-peserta.php?id=<?php echo $row['id_pendaftaran'] ?>"
                                onclick="return confirm('Apakah Anda Yakin untuk Menolak?')">Tolak</a> |
                            <a href="terima.php?id=<?php echo $row['id_pendaftaran'] ?>">Terima</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
